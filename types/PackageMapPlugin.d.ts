...
declare class PackageMapPlugin {
     ...
     */
    constructor(source: string | ResolveStepHook, options: PackageMapOptions, symlinks: boolean, target: string | ResolveStepHook);
     ...
     * @returns {void}
     */
    _getPackageMap(resolver: Resolver, resolveContext: ResolveContext, callback: PackageMapCallback): void;
    /**
     ...
     * @returns {void}
     */
    _resolveConfigFile(resolver: Resolver, callback: (configFile: string) => void): void;
    /**
     * @param {Resolver} resolver the resolver
     * @returns {void}
     */
...
declare namespace PackageMapPlugin {
    export { Resolver, ResolveContext, ResolveRequest, ResolveStepHook, PackageMap, PackageMapPackages, PackageMapOptions, PackageMapCallback };
}
