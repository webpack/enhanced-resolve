/*
 * CodSpeed <-> tinybench bridge for enhanced-resolve benchmarks.
 *
 * Ported from the equivalent wrapper in webpack's
 * test/BenchmarkTestCases.benchmark.mjs. The webpack version additionally
 ...
 * simulation mode. webpack hit the same issue and uses @codspeed/core
 * directly — we follow their lead.
 *
