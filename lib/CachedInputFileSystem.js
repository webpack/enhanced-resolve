...
module.exports = class CachedInputFileSystem {
	constructor(fileSystem, duration) {
		...
		this._realpathStorage = new Storage(duration);
		...
		this._realpath = this.fileSystem.realpath
			? this.fileSystem.realpath.bind(this.fileSystem)
			: null;
		if (!this._realpath) this.realpath = /** @type {any} */ (null);

		this._realpathSync = this.fileSystem.realpathSync
			? this.fileSystem.realpathSync.bind(this.fileSystem)
			: null;
		if (!this._realpathSync) this.realpathSync = /** @type {any} */ (null);
	}
	...
	realpathSync(path) {
		return this._realpathStorage.provideSync(path, this._realpathSync);
	}
	...
	purge(what) {
		...
		this._realpathStorage.purge(what);
	}
};
