...
exports.createResolver = function(options) {
	...
	resolver.ensureHook("finalResolved");
	...
	if (resolveToContext) {
		...
		plugins.push(
			new NextPlugin("undescribed-existing-directory", "final-resolved")
		);
	} else {
		// undescribed-existing-directory
		plugins.push(
		...
		plugins.push(new NextPlugin("existing-file", "final-resolved"));
	}

	// final-resolved
	if (restrictions.size > 0) {
		plugins.push(
			new RestrictionsPlugin("final-resolved", restrictions, "resolved")
		);
	} else {
		plugins.push(new NextPlugin("final-resolved", "resolved"));
	}
