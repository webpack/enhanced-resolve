...
exports.createResolver = function(options) {
	...
	let descriptionFiles = options.descriptionFiles || ["package.json"];
	...
	let plugins = (options.plugins && options.plugins.slice()) || [];

	// A list of main fields in description files
	let mainFields = options.mainFields || ["main"];

	// A list of alias fields in description files
	let aliasFields = options.aliasFields || [];
	...
	let enforceExtension = options.enforceExtension || false;
	...
	let enforceModuleExtension = options.enforceModuleExtension || false;

	// A list of module alias configurations or an object which maps key to value
	let alias = options.alias || [];

	// Resolve symlinks to their symlinked location
	let symlinks = typeof options.symlinks !== "undefined" ? options.symlinks : true;

	// Resolve to a context instead of a file
	let resolveToContext = options.resolveToContext || false;
	...
	let cachePredicate = options.cachePredicate || function() {
		return true;
	};
