...
exports.createResolver = function(options) {
	...
	// Limits module paths in hierarchic directories to be contained within the given path. Must be an absolute path.
	...
	modules.forEach(item => {
		if (Array.isArray(item))
			plugins.push(
				new ModulesInHierachicDirectoriesPlugin("module", item, jail, "resolve")
			);
