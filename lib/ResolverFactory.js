 ...
 * @property {Set<string>} descriptionFiles
 ...
 * @property {Set<string | string[]>} modules
...
function createOptions(options) {
	...
	for (const item of mainFieldsSet.values()) {
 ...
 * @returns {Set<string | string[]>} merge result
 */
function mergeFilteredToSet(array, filter) {
	return new Set(
		array.reduce((/** @type {Array<string | string[]>} */ array, item) => {
			if (filter(item)) {
