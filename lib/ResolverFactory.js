...
exports.createResolver = function(options) {
	...
	resolver.ensureHook("undescribedModule");
	...
	resolver.ensureHook("finalize-file");
	...
	modules.forEach(item => {
		if (Array.isArray(item))
			...
			plugins.push(
				new ModulesInRootPlugin("raw-module", item, "undescribed-module")
			);
	});
	plugins.push(
		new DescriptionFilePlugin(
	...
	plugins.push(new NextPlugin("after-undescribed-module", "module"));

	// module
	plugins.push(
		new ExportsFieldPlugin("module", "finalize-file", conditionNames)
	);
	...
	if (resolveToContext) {
		...
		plugins.push(new NextPlugin("file", "finalize-file"));

		plugins.push(new FileExistsPlugin("finalize-file", "existing-file"));
