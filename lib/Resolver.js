...
const { createCachedGetPaths } = require("./getPaths");
...
/** @typedef {import("./getPaths").CachedGetPaths} CachedGetPaths */

/**
 * @typedef {object} GetPathsCacheEntry
 * @property {CachedGetPaths["fn"]} fn cached getPaths function
 * @property {CachedGetPaths["cache"]} cache the underlying cache map
 */
 ...
 * @property {GetPathsCacheEntry} getPaths cached getPaths (ancestor walk)
 */
