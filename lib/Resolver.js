 ...
 * @property {function(string, function(Error | null, Buffer=): void): void} readFile
 * @property {function(string, function(Error | null, string=): void): void} readlink
 * @property {function(string, function(Error | null, import("fs").Stats=): void): void} stat
 */
