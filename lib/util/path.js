...
/**
 * @returns {{ fn: (rootPath: string, request: string) => string, cache: Map<string, Map<string, string | undefined>> }} cached join
 */
const createCachedJoin = () => {
	/** @type {Map<string, Map<string, string | undefined>>} */
	const cache = new Map();
	/** @type {(rootPath: string, request: string) => string} */
...
/**
 * @returns {{ fn: (maybePath: string) => string, cache: Map<string, string> }} cached dirname
 */
const createCachedDirname = () => {
	/** @type {Map<string, string>} */
	const cache = new Map();
	/** @type {(maybePath: string) => string} */
	const fn = (maybePath) => {
